...
public class searchvalue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LSRvalue = new javax.swing.JLabel();
        SRvalue = new javax.swing.JLabel();
        LSPvalue = new javax.swing.JLabel();
        SPvalue = new javax.swing.JLabel();
        LSVvalue = new javax.swing.JLabel();
        SVvalue = new javax.swing.JLabel();
        ...
        LSRvalue.setText("Search Range");

        LSPvalue.setText("Search Perception");

        LSVvalue.setText("Search Visibility");
        ...
        C1Layout.setHorizontalGroup(
            ...
            .addGroup(C1Layout.createSequentialGroup()
                ...
                .addGroup(C1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(C1Layout.createSequentialGroup()
                        .addComponent(site, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(Lsite, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(25, 25, 25))
                    .addGroup(C1Layout.createSequentialGroup()
                        .addGroup(C1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(LSRvalue)
                            .addComponent(SRvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(26, 26, 26)
                        .addGroup(C1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(C1Layout.createSequentialGroup()
                                .addComponent(SPvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(SVvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(C1Layout.createSequentialGroup()
                                .addComponent(LSPvalue)
                                .addGap(18, 18, 18)
                                .addComponent(LSVvalue)))
                        .addGap(6, 6, 6))))
        );
        C1Layout.setVerticalGroup(
            ...
            .addGroup(C1Layout.createSequentialGroup()
                ...
                .addGroup(C1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(LSRvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LSPvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LSVvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(C1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(SRvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(SPvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(SVvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void executeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeActionPerformed
        ...
        try {
            url = "http://public.seodiver.com/d.api?d=sr&url="+site.getText()+"&format=json&decimals=6&decimal=.";
            obj = new URL(url);
            ...
            else
            {
                ...
                value = JsonPath.read(response, "$.value");
                SRvalue.setText(value);
                in.close();
            }
            url = "http://public.seodiver.com/d.api?d=sp&url="+site.getText()+"&format=json&decimals=6&decimal=.";
            obj = new URL(url);
            con = (HttpURLConnection) obj.openConnection();
            con.setRequestProperty("User-Agent", "Anagha");
            responseCode = con.getResponseCode();
            ...
            else
            {
                ...
                response=in.readLine();
                value = JsonPath.read(response, "$.value");
                SPvalue.setText(value);
                in.close();
            }
            url = "http://public.seodiver.com/d.api?d=sv&url="+site.getText()+"&format=json&decimals=6&decimal=.";
            obj = new URL(url);
            con = (HttpURLConnection) obj.openConnection();
            con.setRequestProperty("User-Agent", "Anagha");
            responseCode = con.getResponseCode();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchvalue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchvalue().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel C1;
    private javax.swing.JLabel LSPvalue;
    private javax.swing.JLabel LSRvalue;
    private javax.swing.JLabel LSVvalue;
    private javax.swing.JLabel Lsite;
    private javax.swing.JPanel Main;
    private javax.swing.JLabel SPvalue;
    private javax.swing.JLabel SRvalue;
    private javax.swing.JLabel SVvalue;
