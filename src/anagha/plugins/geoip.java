 ...
 * @author shanky
 */
public class geoip extends javax.swing.JFrame {

    /**
     * Creates new form geoip
     */
    ...
    private void executeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeActionPerformed
        ...
        try {
            url = "http://freegeoip.net/json/"+site.getText();
            obj = new URL(url);
            ...
            else
            {
                ...
                String IP = JsonPath.read(response, "$.ip");
                String countryCode = JsonPath.read(response, "$.country_code");
                String countryName = JsonPath.read(response, "$.country_name");
                String region = JsonPath.read(response, "$.region_name");
                String city = JsonPath.read(response, "$.city");
                value.append("\n"+"IP: "+IP);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(geoip.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
